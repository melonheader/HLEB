#!/usr/bin/bash
### INFO: Count genome N for conversion rate estimation from SE Slamseq
### DATE: 04.09.2020
...
echo "Experiment: $exp"
echo "Purpose: Count genome N for conversion rate estimation in .bam files from SE-Slamseq"
echo ""
