#!/usr/bin/bash
### INFO: Count genome T -> C conversions from SE Slamseq
### DATE: 11.08.2020
...
cntr_path="/local/artem/Projects/"$project"/Scripts/Slamseq/row_mpile_coverage_plus_TC.pl"
...
echo "Experiment: $exp"
echo "Purpose: Count T -> C conversions in .bam files from SE-Slamseq"
echo ""
